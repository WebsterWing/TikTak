...
public class Game extends SingleTableModel {
	...
	public Game(String username1, String username2,	List<GameMove> gameMoves) {
		this();
		// this.id = id;
	...
	public String getMetadata() {
		return "METADATA#" + Helpers.formatDate(createdTime);
	}
	*/
	...
	public String toString() {
		return "Game [id=" + getId() + ", username1=" + username1 + ", username2=" + username2 + ", createdTime="
